...
import com.king.run.activity.sport.AspectRatioFragment;
...
@ContentView(R.layout.activity_self_camera)
public class SelfCameraActivity extends BaseActivity implements
    ...
    private static final int PUBLISH_CODE = 212;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch_flash.setBackgroundResource(R.drawable.ic_flash_auto);
        if (mCameraView != null) {
            mCameraView.addCallback(mCallback);
        }
    }

    @Event(value = {R.id.switch_flash, R.id.switch_camera, R.id.iv_take_pic})
...
//                    item.setIcon(FLASH_ICONS[mCurrentFlash]);
                    switch_flash.setBackgroundResource(FLASH_ICONS[mCurrentFlash]);
