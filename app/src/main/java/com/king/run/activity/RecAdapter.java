...
public class RecAdapter extends RecyclerView.Adapter<RecAdapter.VH> {
    ...
    // 准备要显示的图片资源
    private int[] imageIdArray = {R.mipmap.train_share_pic_1, R.mipmap.train_share_pic_2, R.mipmap.train_share_pic_3, R.mipmap.train_share_pic_4, R.mipmap.train_share_pic_5, R.mipmap.train_share_pic_6};
