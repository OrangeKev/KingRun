 ...
 * 步数统计Fragment
 */
@ContentView(R.layout.fragment_steps_statistics)
public class StepsLinesFg extends BaseFragment  {

    @ViewInject(R.id.line_chart_week_steps)
    private LineChart lineChart;

    private String[] mDayItems = new String[]{"5.1", "5.2", "5.3", "5.4", "5.5", "5.6", "今天"};
    private double[] mDayPoints = new double[]{1000, 1234, 3546, 5600, 8741, 10000, 3001};
...
//        drawLineChart();
    ...
    public void setDatasChanged(ArrayList<StatisticsItem> datas) {
        items.clear();
        items.addAll(datas);
